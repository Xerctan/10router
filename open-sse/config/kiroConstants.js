 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what 10Router needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a 10Router
 ...
 * The suffix is a 10Router request override, not part of Kiro's upstream model id.
 */
...
/**
 * Detect whether a model id refers to a 10Router synthetic agentic variant.
...
/**
 * Detect whether a model id is a 10Router synthetic thinking variant
...
/**
 * Resolve a 10Router model id to the real upstream Kiro model id, plus flags
